...
regd_users.put("/auth/review/:isbn", (req, res) => {
  ...
  // Initialize reviews if not already done
  if (!books[isbn].reviews) {
    books[isbn].reviews = {};
  }

  books[isbn].reviews[username] = review;
  res.json({ message: `The review for the book isbn ${isbn} has been added/updated.` })
});
...
regd_users.delete("/auth/review/:isbn", (req, res) => {
  ...
  res.json({ message: `The review for the book isbn ${isbn} has been deleted.` })
});
